...
// ----------------------------------------------------------------------------
// vtkInteractorStyleNinjatoSlice methods
// ----------------------------------------------------------------------------

function vtkInteractorStyleNinjatoSlice(publicAPI, model) {
  // Set our className
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkInteractorStyleNinjatoSlice(publicAPI, model);
}
...
export const newInstance = macro.newInstance(
  extend,
  'vtkInteractorStyleNinjatoSlice'
);
