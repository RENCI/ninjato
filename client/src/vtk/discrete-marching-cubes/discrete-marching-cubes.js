...
// ----------------------------------------------------------------------------
// vtkDiscreteMarchingCubes methods
// ----------------------------------------------------------------------------

function vtkDiscreteMarchingCubes(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkDiscreteMarchingCubes');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  macro.algo(publicAPI, model, 1, 1);
  vtkDiscreteMarchingCubes(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkDiscreteMarchingCubes');
