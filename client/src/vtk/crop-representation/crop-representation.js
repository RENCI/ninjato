...
// ----------------------------------------------------------------------------
// vtkCropRepresentation methods
// ----------------------------------------------------------------------------

function vtkCropRepresentation(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkCropRepresentation');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkCropRepresentation(publicAPI, model);
}
