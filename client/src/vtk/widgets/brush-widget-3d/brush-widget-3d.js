...
function vtkBrushWidget3D(publicAPI, model) {
  model.classHierarchy.push('vtkBrushWidget3D');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkBrushWidget3D(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkBrushWidget3D');
